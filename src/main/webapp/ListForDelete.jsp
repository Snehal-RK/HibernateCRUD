					...
					<table class="table table-borderless text-light">
						...
						%>
							<tr>
								...
								<td> <a class="btn btn-warning disabled text-light shadow pl-4 pr-4 mb-3 bg-body rounded border-0" href="update?id=<%= entity.getId()%>"> Update </a> </td>
								<td> <a class="btn btn-danger text-light shadow pl-4 pr-4 mb-3 bg-body rounded border-0" href="delete?id=<%= entity.getId()%>"> Delete </a> </td>
							</tr>
						<%
								}
							}
